...
Pull requests are so named basically because you are asking someone to _pull_ changes from your local repository to their remote repository. And that's because you have to ask permission to copy changes out of the repository, even if you have read access to that repository.
